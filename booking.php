<?php $title='Book a Cruise'; include '_top.php'; ?>
    ...
    <div id="formContainer">
        <form>
            <label class="topLabel">Full Name* <input type="text" name="name" required></label>
            <label class="topLabel">Address <input type="text" name="address"></label>
            <label class="topLabel">City <input type="text" name="city"></label>
            <label class="topLabel">State
                <select>
